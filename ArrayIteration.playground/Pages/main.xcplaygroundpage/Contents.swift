...
var ingredientsLearnCo = ["Chips", "Salsa", "Guacamole", "Red Wine"]
 ...
 */
let testArray = [10, 60, 30]

func arrayLessThan50(allInts: [Int]) -> [Int] {
    var newArray: [Int] = []
    for i in allInts {
        if i < 50 {
            newArray.append(i)
...
print(arrayLessThan50(allInts: testArray))
//print(arrayLessThan50(allInts: newArray))
...
print(lessThan50(numbers: testArray))
