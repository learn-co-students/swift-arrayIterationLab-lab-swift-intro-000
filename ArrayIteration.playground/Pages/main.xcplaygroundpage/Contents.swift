 ...
 */
let names = ["Ryan", "Mumford", "Toni", "Madame", "Link", "Goblin", "Michael"]
 ...
 */
let longNumberList = [1, 2, 3, 4, 51, 60, 100]

func list50(numberArray: [Int]) -> [Int] {
    var newList: [Int] = []
...
print(list50(numberArray: longNumberList))
