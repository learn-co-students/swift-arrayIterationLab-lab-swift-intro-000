 ...
 */
var partyAppetizers = ["Chips", "Salsa", "Guacamole", "Red wine"]
 ...
 */
let shoppingCartItems = ["Chips", "Salsa", "Guacamole", "Red wine"]

for partyFood in shoppingCartItems {
    print(partyFood)
}
 ...
 */
func greeting(partygoers: [String]) {

for individual in partygoers {
    ...
    greeting(partygoers: ["Dan", "Nolan", "Michael", "Pippa"])
 ...
 */
    func arrayInts(numbers: [Int]) ->  [Int] {
        var result: [Int] = []
