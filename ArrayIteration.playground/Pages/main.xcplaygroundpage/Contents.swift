 ...
 */
    func getLessThan50(numbers: [Int]) -> [Int] {
        var lessThan50Numbers: [Int] = []
        for number in numbers {
            if number < 50 {
                lessThan50Numbers.append(number)
            }
        }
        return lessThan50Numbers
    }

print(getLessThan50(numbers: [34, 56, 74, 12, 56, 23, 49]))
