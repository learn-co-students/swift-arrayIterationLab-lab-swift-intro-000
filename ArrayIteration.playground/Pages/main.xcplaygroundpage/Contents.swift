...
shoppingCart = ["Chips","Guacamole","Red wine"]
/*: question2
...
func showGreeting(charNames: [String])
{
...
let names: [String] = ["Deran","Keshni","Saiyen","Michael","Kelly","Gordan"]
showGreeting(charNames: names)
...
let oldNumbers: [Int] = [10,20,30,40,49,50,60,10,70,100,101,1,2,3,4,5]
let newNumber: [Int] = lessThanFifty(numbers: oldNumbers)
print (newNumber)
