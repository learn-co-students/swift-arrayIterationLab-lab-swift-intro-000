 ...
 */
func printCart(contents: Array<String>) {
    for item in contents {
        print(item)
    }
}

printCart(contents: shoppingCart)
 ...
 */
func morningGreeating(people: Array<String>) {
...
morningGreeating(people: ["Foo", "Bar", "Michael"])
...
func numbersLessThan50(numbers: Array<Int>) -> Array<Int> {
    var lessThan50: [Int] = []
...
numbersLessThan50(numbers: numbers)
