...
var names = ["Joe", "Susan", "Michael", "Tiffany"]
...
func lessThan50(numbs: [Int]) -> [Int] {
    var newArray: [Int] = []
    for numb in numbs {
        if (numb <= 50) {
            newArray.append(numb)
        }
    }
    return newArray
}
