 ...
 */
func shoppingCart(items: [String]) {
    for item in items {
        print(item)
    }
}
...
let listOfNames: [String] = ["Tim", "Danielle", "Michael", "Melissa"]

greeting(names: listOfNames)
 ...
 */
let allNumbers: [Int] = [40, 60, 50, 52, 59, 13, 90, 100, 5, 52, 51, 49]
var lessThanFifty: [Int] = []

func findNumbers(numbers: [Int]) {
...
findNumbers(numbers: allNumbers)
print(lessThanFifty)
