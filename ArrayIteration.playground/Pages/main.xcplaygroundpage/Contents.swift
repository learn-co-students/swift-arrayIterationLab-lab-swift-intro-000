 ...
 */
var ingredientsForAnAwesomeNight: [String] = ["Chips", "Salsa", "Guacamole", "Red wine"]
 ...
 */
for ingredient in ingredientsForAnAwesomeNight {
    print(ingredient)
}
 ...
 */
func lessThanFifty(integers: [Int]) -> [Int] {
    var intsLessThanFifty: [Int] = []
    
    for integer in integers {
        if integer < 50 {
            intsLessThanFifty.append(integer)
        }
    }
    
    return intsLessThanFifty
}
