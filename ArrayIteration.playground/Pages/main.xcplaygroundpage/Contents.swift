 ...
 */
// write your code here
func arrayMessage(Names: [String]){
    for name in Names{
        if name == "Michael"{
...
func intArrayFunc(numbers: [Int]){
    var newArray: [Int]
    for everyInt in numbers{
        if everyInt < 50 {
            newArray.append(everyInt)
        }
    }
}
