...
var craft = ["Chips", "Salsa", "Guacamole","Red wine"]
 ...
 */
// write your code here
var people = ["Michael", "Bob", "Ahmed", "Joe"]
 ...
 */
// write your code here
func arrayOfNumbers(arrayNumbers: [Int]) -> [Int] {
    var numberUnder50: [Int] = []
    
    for eachNumber in arrayNumbers {
        if eachNumber < 50 {
            numberUnder50.append(eachNumber)
        }
    }
    
    print(numberUnder50)
    return numberUnder50
