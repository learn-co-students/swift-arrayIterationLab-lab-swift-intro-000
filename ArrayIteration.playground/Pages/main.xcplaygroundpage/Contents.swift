 ...
 */
var partyFoods: [String] = ["Chips", "Salsa", "Guacamole", "Red Wine"]
...
var namesOfPpl = ["Jeff", "Steve", "Michael", "Holly"]

greeting(names: namesOfPpl)
 ...
 */
func intReturn (numbers: [Int]) -> [Int] {
    var newInts: [Int] = []
    for number in numbers {
        if number < 50 {
            newInts.append(number)
        }
    }
    return newInts
}

let randomNums = [1, 55, 921, 11, 23, 53, 99]

intReturn(numbers: randomNums)
