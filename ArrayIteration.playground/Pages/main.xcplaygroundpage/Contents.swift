 ...
 */
var cartIngredients = ["Chips", "Salsa", "Guacamole", "Red wine"]
 ...
 */
func specialGreetings(nameList: [String]) {
...
var friendsFromWork = ["Elisa", "Jayme", "Lily", "Michael", "Frankie", "Violet", "Schlomo"]
specialGreetings(nameList: friendsFromWork)
 ...
 */
func isLessThan50(testNumbers: [Int]) -> [Int] {
...
var listOfNumbers = [4, 78, 230, 23, 18, 37, 56, 893, 671, 71, 123, 2]
print("\(isLessThan50(testNumbers: listOfNumbers))")
