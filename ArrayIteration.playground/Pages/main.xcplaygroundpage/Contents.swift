...
var recipeIngredients : [String] = ["Chips", "Salsa", "Guacamole", "Red Wine"]
 ...
 */
// write your code here
var names : [String] = ["Jessica", "Ashley", "Michael", "Nick", "Kala"]
 ...
 */
// write your code here
var intArray : [Int] = [1, 33, 100, 1000, 63, 44, 200]
func intSeparator(Array: [Int]){
    var underFifty : [Int] = []
