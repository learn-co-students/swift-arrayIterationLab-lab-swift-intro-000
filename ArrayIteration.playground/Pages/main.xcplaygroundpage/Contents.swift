 ...
 */
var snackNight = ["Chips", "Salsa", "Guacamole", "Red wine"]
...
func goodMorningFriend(names: [String]){
    for name in names {
        if name == "Michael"{
...
goodMorningFriend(names: ["Bill", "Bob", "Michael"])
 ...
 */
func numbersForThis(numbers: [Int]) -> [Int] {
    var outcome: [Int] = []
    for number in numbers {
        if number < 50 {
...
numbersForThis(numbers: [1, 2, 50, 56, 300, 20, 23])
