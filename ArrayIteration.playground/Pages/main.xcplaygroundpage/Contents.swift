 ...
 */
let mexicanIngredients = ["Chips", "Salsa", "Guacamole", "Red Wine"]
 ...
 */
for ingredient in mexicanIngredients {
    print(ingredient)
}
 ...
 */
func youAwake(names: Array<String>) {
    for name in names {
        if name == "Michael" {
...
let myNames = ["Bobby", "Stooey", "Michael"]
youAwake(names: myNames)
/*: question6
 ...
 */
func moreOrLessThanFifty(numbers: Array<Int>) -> [Int] {
...
let myNumbers = [4, 78, 3, 59]
moreOrLessThanFifty(numbers: myNumbers)
