...
var dinnerList = ["Chips", "Salsa", "Guacamole", "Red wine"]
 ...
 */
// write your code here
func greetingMessage(names:Array<String>) {
    for name in names {
        if name == "Michael" {
...
greetingMessage(names: ["Michael", "Michelle"])
 ...
 */
// write your code here
let firstList = [100,2,3,59,60,10,45]
var secondList: [Int] = []

func newList(numbers:Array<Int>) -> Array<Int> {
