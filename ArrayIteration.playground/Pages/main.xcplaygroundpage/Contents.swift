 ...
 */
var salsa:[String] = ["chips", "salsa", "guacamole", "red wine"]
...
var names = ["Paul", "clara", "Michael", "Steve", "paul"]
greeting(namelist: names)
...
var someNumbers = [43, 45, 76, 34, 65, 26, 345, 34, 43, 12, 37, 28, 56, 19]
lessThan50(Ints: someNumbers)
