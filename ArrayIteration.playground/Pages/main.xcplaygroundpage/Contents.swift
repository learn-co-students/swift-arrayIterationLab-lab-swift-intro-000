 ...
 */
var ingredients = ["Chips", "Guacamole", "Red wine"]
...
func greet(names: Array<String>) {
    for name in names {
        name == "Michael" ? print("Top of the morning Michael") : print("Good morning \(name)")
    }
}
 ...
 */
func lessThan50(integers: Array<Int>) -> Array<Int> {
